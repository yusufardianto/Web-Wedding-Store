        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
          ...
          <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
              ...
              <a href="{{ route('dashboard-setting-store') }}" class="list-group-item list-group-item-action" {{ (request()->is('dashboard/settings*')) ? 'active' : ''}}>
                Store Settings
              </a>
              <a href="{{ route('dashboard-setting-account') }}" class="list-group-item list-group-item-action" {{ (request()->is('dashboard/accounts*')) ? 'active' : ''}}>
                My Account
              </a>
