               ...
               <div class="row"> 
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="Papel La Casa" value="{{ $product->name }}">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Price</label>
                    <input type="number" name="price" class="form-control" value="200" value="{{ $product->price }}>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
